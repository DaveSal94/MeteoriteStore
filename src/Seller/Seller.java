...
public class Seller extends JDialog implements ActionListener {
	...
	public Seller ( double lonCoord, double latCoord , String newname)
	{
	...
	* Function: loadSeller
	* Parameters: N/A
	* Description:This function loads a file of the seller.
	* Inputs: N/A
	* Outputs: new locations of the Position class for seller.
	********************************************/
	...
	* Function: save
	* Parameters: N/A
	* Description:This function saves the sellers information. The file is comma separated
 	*				values with  original location, and sellers name. 
	* Inputs: File name
