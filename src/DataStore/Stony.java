...
public class Stony extends AsteroidalAchondrite{
	...
	public Stony(double newlongitude, double newlatitude, float newprice,int newIDnum,int newtype,boolean newSold, int newPercentIron, int newPercentStone,int newPercentCrystal) {
