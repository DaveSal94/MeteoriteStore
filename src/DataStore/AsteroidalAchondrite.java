...
* Description: This class a subclass of achondrite with data member of type 
...
public class AsteroidalAchondrite extends Achondrite {
	...
	int PercentIron, PercentStone, PercentCrystal;
	public AsteroidalAchondrite(double newlongitude, double newlatitude,float newprice, int newIDnum,int newtype, boolean newSold, int newPercentIron, int newPercentStone, int newPercentCrystal) {
		super(newlongitude, newlatitude, newprice, newIDnum,newtype,newSold);
		PercentIron = newPercentIron;
		PercentStone = newPercentStone;
		PercentCrystal = newPercentCrystal;
	}
	/*******************************************************
	...
	* Outputs: suggested price
	...
	public float pricefunction(float priceval,Position location)
	{
		...
		float currentprice =(float) 250.00 + cont.LoadFile(location);//+ cont price
