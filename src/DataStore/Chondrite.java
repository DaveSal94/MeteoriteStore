...
**************************************************/
public class Chondrite extends Meteorites {
	
	Continents cont = new Continents();
	public Chondrite(double newlongitude, double newlatitude, float newprice,int newIDnum,int newtype, boolean newSold) {
	...
	* Outputs: suggested price
	...
	public float pricefunction(float priceval,Position location)
	{
		...
		float currentprice =(float) 50.00 + cont.LoadFile(location) ;//+ cont price
