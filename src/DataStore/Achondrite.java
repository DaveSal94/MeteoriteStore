...
**************************************************/
public class Achondrite extends Meteorites{
	Continents cont = new Continents();
	public Achondrite(double newlongitude, double newlatitude, float newprice,int newIDnum,int newtype,boolean newSold) {
	...
	* Outputs: suggested price
	...
	public float pricefunction(float priceval,Position location)
	{
		...
		float currentprice =(float) 150.00 + cont.LoadFile(location);
                System.out.println(cont.LoadFile(location));
