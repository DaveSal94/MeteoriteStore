...
public class StonyIron extends AsteroidalAchondrite{
	...
	public StonyIron(double newlongitude, double newlatitude, float newprice,int newIDnum,int newtype, boolean newSold, int newPercentIron, int newPercentStone,int newPercentCrystal) {
		super(newlongitude, newlatitude, newprice, newIDnum,newtype,newSold, 50,50, 0);
